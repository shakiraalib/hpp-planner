...
# --- 3. THEME & STYLING (STYLE ASLI KAMU) ---
def apply_styling():
    st.markdown("""
    <style>
    ...
    * { font-family: 'Plus Jakarta Sans', sans-serif; color: #4A4A4A; }
    ...
    /* UI Header Kolom */
    .table-header { font-size: 12px; font-weight: 700; color: #D08C9F; margin-bottom: 5px; }
    </style>
...
with st.sidebar:
    ...
    if prod_name:
        ...
        if 'ai_res' in st.session_state:
            ...
            # FITUR MAGIC BUTTON YANG SEMPAT HILANG
...
# HEADER KOLOM (Agar Qty Jelas & Blok Putih Hilang)
...
st.markdown("<div class='p-card'>", unsafe_allow_html=True)
# Langsung tombol, tanpa ada blok input kosong di bawah judul
...
# STEP 3 & 4 (Tetap Sesuai Layout & Warna Kamu)
